  ...
  return (
    <div className="bg-white min-h-screen px-4 py-8 flex flex-col">
      ...
      <div className="max-w-xs mx-auto flex-1">
        <h2 className="text-3xl font-bold mb-6 mt-24 text-center">재료를 넣어주세요</h2>
        ...
        <div className="flex flex-col items-center mb-8 w-full">
          {tags.map((tag, index) => (
            <div key={index} className="bg-gray-200 rounded-full px-3 py-2 mt-2 text-sm font-semibold text-gray-700 my-1 flex items-center justify-between w-auto">
